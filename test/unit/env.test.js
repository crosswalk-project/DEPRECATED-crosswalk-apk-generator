...
describe('Env.configure()', function () {
  ...
  it('should resolve to the Env if configure() is successful', function (done) {
    ...
    var expectedConfig = {
      ...
      androidAPIVersion: Env.CONFIG_DEFAULTS.androidAPIVersion,
      androidAPILevel: parseInt(Env.CONFIG_DEFAULTS.androidAPIVersion, 10),
      dx: fixsep('/foo/build-tools/19.0.0/dx'),
      aapt: fixsep('/foo/build-tools/19.0.0/aapt'),
